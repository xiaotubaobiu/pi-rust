...
mod tests {
  ...
  "mistral": {"supportsMidConvoSystemMessages": true}
    ...
    fn allowed_fallback_model_fields_are_required() {
        ...
        let fixture = r#"{"provider":"openrouter","model":"qwen/qwen3-coder","cost":{"input":3.0,"output":15.0,"cacheRead":0.3,"cacheWrite":3.75}}"#;
