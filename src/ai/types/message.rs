...
mod tests {
    ...
    const TOOL_RESULT_FULL: &str = r#"{"role":"toolResult","toolCallId":"call_1","toolName":"bash","content":[{"type":"text","text":"total 0"},{"type":"image","data":"aGVsbG8=","mimeType":"image/png"}],"details":{"exitCode":0,"files":["a.txt"]},"usage":{"input":0,"output":0,"cacheRead":0,"cacheWrite":0,"totalTokens":0,"cost":{"input":0.0,"output":0.0,"cacheRead":0.0,"cacheWrite":0.0,"total":0.0}},"isError":false,"timestamp":1758240000006}"#;
